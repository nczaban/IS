...
Game theory is the study of interactions between decision-makers. The field defines a game as an interaction constraining the actions a player can perform and the interests of players, with the goal of game theory to determine solutions and outcomes of various games \cite{osbo94}. It is assumed that players in these games are both rational and strategic; they pursue their objectives and take the behavior of other players into account.\\
